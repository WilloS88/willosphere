  ...
  return (
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
        <div className="mb-8 flex items-center justify-between">
          ...
          <Link
            href={`/${locale}/home/artist/tracks/new`}
        ...
        {loading ? (
          ...
          <div className={`rounded border p-10 text-center ${cardCls}`}>
            ...
            <div className={`text-xs tracking-widest uppercase ${mutedCls}`}>{t("noRecentTracks")}</div>
            <Link
              href={`/${locale}/home/artist/tracks/new`}
            ...
            {tracks.map((track) => (
              <div key={track.id} className={`flex items-center gap-4 rounded border px-4 py-3 ${cardCls}`}>
                ...
                <div className="flex shrink-0 items-center gap-2">
                  <Link
                    href={`/${locale}/home/artist/tracks/${track.id}/edit`}
